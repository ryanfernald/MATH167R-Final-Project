...
x <- "https://raw.githubusercontent.com/ryanfernald/MATH167R-Final-Project/main/DATA/Percentages%20stats%20health%20outcomes.csv"
data <- read.csv(x)

# Reshape the data to a long format
data_long <- gather(data, key = "Health_Outcome", value = "Percentage", -Usage)

# Create the ggplot with multiple bar graphs
ggplot(data_long, aes(x = Health_Outcome, y = Percentage, fill = Usage)) +
